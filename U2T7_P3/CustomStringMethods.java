public class CustomStringMethods {
  ...
  */
  ...
  /**Client provides myString and removeIdx and method returns a new String with the character
    ...
    public String removeCharacter(String myString, int removeIdx) {
        ...
        String string = myString.substring(0, removeIdx);
        String stringPt2 = myString.substring(removeIdx+1);
        return string + stringPt2;
  ...
  */
    public String insertAt(String orig, String insertText, String searchStr) {
        int indexOrig = orig.indexOf(searchStr);
        if (indexOrig == -1) {
            return orig + insertText;
        }
        String before = orig.substring(0, indexOrig);
        String after = orig.substring(indexOrig);
  ...
  */
    public String endUp(String myString, int numToCap){
        ...
        String toBeCap = myString.substring(myString.length()-numToCap);
        String staysSame = myString.substring(0, myString.length()-numToCap);
        return staysSame + toBeCap.toUpperCase();
    }
